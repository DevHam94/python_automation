...
def make_email_list(data_path, partners_filename, title, target_filename='이메일발송목록'):
    ...
    for filename in filenames:
        filename = filenames.replace('.xlsx', '').replace('[패스트몰]', '')
        ...
        partner_manager_name = str(found_row['컨텍담당자'].values[0])
